...
<head>
  ...
  <link rel="stylesheet" href="<?= base_url().CSSPATH ?>/iziToast.min.css">
  ...
  <!-- Bootstrap Tagsinput -->
  <link rel="stylesheet" href="<?= base_url().CSSPATH ?>/bootstrap-tagsinput.css">
  <link rel="stylesheet" href="<?= base_url() ?>/public/assets/bundles/bootstrap-colorpicker/dist/css/bootstrap-colorpicker.min.css">
  <link rel="stylesheet" href="<?= base_url() ?>/public/assets/bundles/ionicons/css/ionicons.min.css">
  <link rel="stylesheet" href="<?= base_url() ?>/public/assets/bundles/owlcarousel2/dist/assets/owl.carousel.min.css">
  <link rel="stylesheet" href="<?= base_url() ?>/public/assets/bundles/owlcarousel2/dist/assets/owl.theme.default.min.css">
  ...
  <link rel="stylesheet" href="<?= base_url() ?>/public/assets/bundles/dropzonejs/dropzone.css">
